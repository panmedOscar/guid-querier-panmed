...
public enum ExcelField {
  ...
  編碼日期(false), GUID(false), MRN(true), SUBJECTID(false), 身份證字號(false),
  姓氏(false), 名字(false), 出生月(false), 出生日(false), 出生年(false), 性別(false), 聯絡電話(
      true), 地址(true), 收案醫師(true), 收案醫院名稱(true);
